...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection" dir="rtl">
...
شريكك للتحول الرقمي             </p>

                <p className="mb-1.5 text-sectiontitle uppercase tracking-[5px]">
                  تواصل الان
                </p>
                <a
                  href="mailto:sales@webled.org"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} WEBLED. All rights reserved
              </p>
            </motion.div>
